...
const Home = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Show work section when scrolled past 600px
      setShowWorkSection(scrollPosition > 600);
    };
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          >
            <div className="max-w-2xl">
              <p className="text-foreground mb-4" style={{ fontSize: '2rem' }}>
                hey hey! i am <span className="font-bold">umair khan</span>.
              </p>
              
              <p className="text-base md:text-lg text-foreground mb-8">
                I am an engineer, vibe-coder, and jira-enthusiast! (a.k.a. business analyst).
              </p>
              ...
              <p className="text-base md:text-lg text-muted-foreground mb-4">
                it is currently VIP (vibe-code in progress).
              </p>
      ...
      {/* Work Section */}
      <section className={`py-20 px-6 md:px-16 lg:px-24 transition-all duration-700 ${
                  ...
                  >
                    <div className="space-y-1">
                      <h3 
                        ...
                        onMouseEnter={() => setHoveredWorkItem(item.slug)}
              ...
              <div className="hidden md:block sticky top-24 h-[400px]">
                <div className="w-full h-full bg-muted/30 rounded-lg overflow-hidden transition-opacity duration-300">
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-muted to-muted/50 relative overflow-hidden flex items-center justify-center">
                    ...
                    {hoveredWorkItem === 'the-last-train' && (
                      <svg className="w-full h-full" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
